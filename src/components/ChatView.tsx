...
import { Send, Hash, MessageSquare, Coffee, Tag, X } from 'lucide-react';
...
export default function ChatView({ user, profile, org, divisionId, onNavigateToTask }: ChatViewProps) {
  ...
  return (
    <div className="h-full flex flex-col bg-white overflow-hidden relative">
      ...
      <div className="flex-1 overflow-y-auto p-8 space-y-6 z-10 no-scrollbar bg-[#FDFDFD]">
        {messages.length === 0 && (
      ...
      <div className="p-8 border-t border-gray-100 shrink-0 bg-white z-10">
