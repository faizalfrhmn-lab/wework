         ...
         <header className="flex flex-col md:flex-row md:items-end justify-between gap-6">
            <div>
              <div className="flex items-center gap-2 mb-4">
                 ...
                 <div>
                    <h1 className="text-2xl font-black text-gray-900 tracking-tighter">Hallo, {profile?.displayName || user.displayName || 'User'}!</h1>
                    <p className="text-gray-400 font-bold text-xs uppercase tracking-widest">Semangat yah hari ini! Kamu punya {activeUserTasks.length} task aktif.</p>
                 </div>
              </div>
            ...
            <div className="flex items-center gap-4 bg-white p-3 rounded-[1.5rem] shadow-xl border border-black/5">
               ...
               <div>
                  ...
                  <p className="text-sm font-black uppercase text-gray-900 tracking-tighter">All Systems Normal</p>
               </div>
            </div>
         </header>
         ...
         <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2 bg-white p-10 rounded-[3rem] shadow-xl border border-black/5 flex flex-col h-[500px]">
               <div className="flex items-center justify-between mb-10">
                 <div>
                   <h3 className="text-2xl font-black uppercase tracking-tighter text-gray-900">Task Velocity</h3>
                   <p className="text-xs font-bold text-gray-400 uppercase tracking-widest mt-1">My completed tasks</p>
                 </div>
