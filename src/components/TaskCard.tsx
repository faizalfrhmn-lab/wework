...
export default function TaskCard({
  ...
  const handleDeleteConfirm = async (e: any) => {
    ...
    console.log('!!! Confirming deletion for task:', task.id);
    setIsDeleting(true);
    try {
    ...
    >
      ...
      >
        <div className="space-y-6">
              ...
              {isConfirmingDelete ? (
                <div className="flex items-center gap-1.5 bg-red-50 border border-red-100 p-1 rounded-xl shadow-xs">
                  ...
                  <button
                     ...
                     disabled={isDeleting}
                     className="px-2.5 py-1 bg-red-600 hover:bg-red-700 text-white rounded-lg text-[9px] font-black uppercase tracking-wider transition-colors disabled:opacity-50 cursor-pointer"
                  >
                    Ya
                  </button>
                  <button
                     ...
                     className="px-2.5 py-1 bg-gray-200 hover:bg-gray-300 text-gray-700 rounded-lg text-[9px] font-black uppercase tracking-wider transition-colors cursor-pointer"
                  >
                    Batal
                  </button>
                </div>
          ...
          {/* Overdue alerts for tasks */}
          {isDeadlinePassed && task.extensionStatus !== 'approved' && (
            <div className="p-4 bg-red-50 border border-red-100 rounded-2xl text-red-600 text-xs font-bold leading-relaxed space-y-1">
              <p className="font-extrabold uppercase text-[10px] tracking-wider text-red-700 flex items-center gap-1.5 animate-pulse">
